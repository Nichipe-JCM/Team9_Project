...
public:
    ...
    void attack(Character* player, UIManager* ui) override;  // Monster의 attack 함수를 오버라이드 // 미드보스 전용 공격 메시지 출력

  
    void GetHit(int damage, UIManager* ui) override; // Monster의 GetHit 함수를 오버라이드 // 미드보스만의 피격 연출 메세지 출력
